...
<!-- 
 ...
 -->
	...
	<p>Welcome to the 2021 BSO Photo Competition. This year, we received 46 photos, from 12 photographers, across the 3 categories.</p>

	<p>Our judges announced the overall category winners on May 12th 2021 at the AGM. At the same time we announced the <em>People’s Choice Award</em> chosen by BSO members. For the second time ever the members agreed with the judges!</p>

	<h3>Category Winner: Plant Portrait</h3>
	<figure class="figure">
		<img src="https://bso.org.nz/f/gqo6lq/1_16_adenochilus_gracilis.jpg" class="figure-img img-fluid rounded" alt="Adenochilus gracilis">
		<figcaption class="figure-caption"><em>Adenochilus gracilis</em> by John Barkla. A colony of orchids on a rotting beech log under silver beech forest, Takitimu Mountains</figcaption>
	</figure>


	<h3>Category Winner: Plants in the Landscape and <em>People’s Choice Award</em></h3>
	<figure class="figure">
		<img src="https://bso.org.nz/f/jx771x/2_11_defiant_before_the_storm.jpg" class="figure-img img-fluid rounded" alt="Alpine Tarns">
		<figcaption class="figure-caption">Defiant before the storm by John Barkla. Slim snow tussock (<em>Chionochloa macra</em>) on the crest of the Dunstan Range.</figcaption>
	</figure>


	<h3>Category Winner: Urban Ecology</h3>
	<figure class="figure">
		<img src="https://bso.org.nz/f/bqe168/3_2_life_behind_bars.jpeg" class="figure-img img-fluid rounded" alt="Takitimu camp">
		<figcaption class="figure-caption">Life behind bars by Allison Knight. This very sick <em>Xanthoria parietina</em> clings to the bars of the fence around Orokonui Ecosanctuary. <em>Tremella</em>, a lichenicolous fungus, caused the pustulous galls on the apothecia.</figcaption>
	</figure>
...
{f: 'https://bso.org.nz/f/d8ddb8/1_2_nothothlapsi_rosulatum.jpg', c: 'Notothlaspi rosulatum - Mt Bitterness, St. Marys Range'},
...
{f: 'https://bso.org.nz/f/bxvbo8/1_4_capsules_up_close.jpg', c: 'Capsules up close - Seed capsules of Disphyma australe peeking out from between the leaves'},
...
{f: 'https://bso.org.nz/f/v85km8/1_7_spring_glory.jpg', c: 'Spring is sprung - Clematis paniculata, female flowers. Pua Wānanga, the child of the star of summer and the star of harvest, signalling that spring is here - time for planting for an abundant harvest.'},
...
{f: 'https://bso.org.nz/f/n8w7dx/1_19_disphyma_austral.jpg', c: 'Disphyma australe - Catlins'},
